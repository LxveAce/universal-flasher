...
## Flashing risk
This writes firmware to your device. Flashing the wrong binary or interrupting a write can **brick hardware**, and it does not verify firmware signatures — check what you flash. That risk is yours.
